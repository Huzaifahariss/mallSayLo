                  ...
                  <tbody>
                    <tr className="pt-30">
                      ...
                      <td className="product-des product-name">
                        <h6 className="mb-5">
                          <a
                            ...
                            href="/shopProduct/shop-product-right.html"
                          >
                      ...
                      <td className="price" data-title="Price">
                        <h4 className="text-body">Rs.2.51 </h4>
                      </td>
                      <td
                      ...
                      <td className="price" data-title="Price">
                        <h4 className="text-brand">Rs.2.51 </h4>
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="price" data-title="Price">
                        <h4 className="text-body">Rs.3.2 </h4>
                      </td>
                      <td
                        className="text-center detail-info"
                        data-title="Stock"
                      ...
                      <td className="price" data-title="Price">
                        <h4 className="text-brand">Rs.3.2 </h4>
                      </td>
                      <td className="action text-center" data-title="Remove">
                        <a href="#" className="text-body">
                          <i className="fi-rs-trash" />
                    ...
                    <tr>
                      ...
                      <td className="price" data-title="Price">
                        <h4 className="text-body">Rs.2.43 </h4>
                      </td>
                      <td
                        className="text-center detail-info"
                        data-title="Stock"
                      ...
                      <td className="price" data-title="Price">
                        <h4 className="text-brand">Rs.2.43 </h4>
                      </td>
                      <td className="action text-center" data-title="Remove">
                        <a href="#" className="text-body">
                          <i className="fi-rs-trash" />
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="cart_total_amount">
                          <h4 className="text-brand text-end">Rs.12.31</h4>
                        </td>
                      </tr>
                      <tr>
