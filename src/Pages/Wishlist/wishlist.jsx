                  ...
                  <tbody>
                    <tr className="pt-30">
                      ...
                      <td className="price" data-title="Price">
                        <h3 className="text-brand">Rs.2.51</h3>
                      </td>
                      <td
                    ...
                    <tr>
                      ...
                      <td className="price" data-title="Price">
                        <h3 className="text-brand">Rs.3.2</h3>
                      </td>
                      <td
                        className="text-center detail-info"
                        data-title="Stock"
                    ...
                    <tr>
                      ...
                      <td className="price" data-title="Price">
                        <h3 className="text-brand">Rs.2.43</h3>
                      </td>
                      <td
                        className="text-center detail-info"
                        data-title="Stock"
                    ...
                    <tr>
                      ...
                      <td className="price" data-title="Price">
                        <h3 className="text-brand">Rs.3.21</h3>
                      </td>
                      <td
                        className="text-center detail-info"
                        data-title="Stock"
                    ...
                    <tr>
                      ...
                      <td className="price" data-title="Price">
                        <h3 className="text-brand">Rs.3.17</h3>
                      </td>
                      <td
                        className="text-center detail-info"
                        data-title="Stock"
